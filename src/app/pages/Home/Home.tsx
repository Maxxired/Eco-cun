...
import {PlantitaAnimada} from "../../Components/plantIA.tsx";
import {PlantIABox} from "../../Components/PlantIABox.tsx";

const Home: React.FC = () => {
    return (
        <main
            className="relative w-full min-h-screen bg-gradient-to-br from-[#ffffff] via-[#d1eddf] to-[#ffffff] overflow-hidden">

            <div className="pt-8 pb-40 px-6 md:px-8">
                <motion.div
